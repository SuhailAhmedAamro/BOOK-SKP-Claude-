      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 w-[350px] h-[480px] bg-white dark:bg-gray-800 rounded-lg shadow-2xl flex flex-col z-50 border-2 border-blue-500/30 dark:border-blue-500/50"
          >
            {/* Header */}
